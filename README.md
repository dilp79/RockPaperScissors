...
Пошаговая игра на шестиугольном поле размером 20x20, где игрок соревнуется с компьютером, размещая элементы "камень", "ножницы" и "бумага" на поле.

## Правила игры

1. Игра происходит на шестиугольном поле размером 20x20.
2. Ход компьютера: компьютер случайным образом выбирает камень, ножницы или бумагу и размещает их на поле в случайных свободных клетках (3 предмета за ход).
